...
class Alert: NSObject {
    ...
    private override init() {
        darkBlueColor = UIColor.systemBlue
    }
    ...
    func showRegistrationCompleteAlert(onViewController: UIViewController) {
        let alert = UIAlertController(title: "Registration complete", message: "Please follow the link sent to your email address to confirm your account", preferredStyle: .alert)
